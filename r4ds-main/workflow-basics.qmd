...
Code can be miserable to read on a good day, so give your eyes a break and use spaces.
...
1.  Why does this code not work? (i becomes l)
...
3.  Press Option + Shift + K / Alt + Shift + K.
    What happens?(we can see all the keyboard shortcuts)
